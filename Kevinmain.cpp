...
int main(int ac, char** av)
{
    ...
    while (true) {
        ...
        cv::Point2f relative_point = cv::Point2f(monster_current_gamefield_position.at(0), monster_current_gamefield_position.at(1                                                                                                                            ));
        
        // Punkt mit der inversen projektiven Transformationsmatrix multiplizieren
        cv::Point3f homogeneous = warp.inv() * relative_point;
        ...
        cout << "\n";
        figureCorners[0] = Point2f(homogeneous.x-550, homogeneous.y-210);
        figureCorners[1] = Point2f(homogeneous.x-540, homogeneous.y-210);
        figureCorners[2] = Point2f(homogeneous.x-540, homogeneous.y-220);
        figureCorners[3] = Point2f(homogeneous.x-550, homogeneous.y-220);
